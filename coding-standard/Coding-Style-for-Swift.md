...
> Based on [raywenderlich/swift-style-guide](https://github.com/raywenderlich/swift-style-guide), under [MIT License](https://github.com/raywenderlich/swift-style-guide/blob/master/LICENSE.txt)
...
- [Swift Coding Style Guide](#swift-coding-style-guide)
- [The Official raywenderlich.com Swift Style Guide.](#the-official-raywenderlichcom-swift-style-guide)
...
In drawing code, use `CGFloat` if it makes the code m