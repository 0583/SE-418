...
CREATE TABLE `color` (
    ...
    `coloralias` VARCHAR(255)CHARACTER SET UTF8 COLLATE UTF8_GENERAL_CI NULL DEFAULT NULL,
    `r` int(3)  UNSIGNED NOT NULL AUTO_INCREMENT,
    `g` int(3) UNSIGNED NOT NULL AUTO_INCREMENT,
    `b` int(3) UNSIGNED NOT NULL AUTO_INCREMENT,
    `c` int(3) UNSIGNED NOT NULL AUTO_INCREMENT,
    `m` int(3) UNSIGNED NOT NULL AUTO_INCREMENT,
    `y` int(3) UNSIGNED NOT NULL AUTO_INCREMENT,
    `k` int(3) UNSIGNED NOT NULL AUTO_INCREMENT,
