...
This code of conduct outlines expectations for Java programming language participation in 0583/SE-418, as well as steps for reporting unacceptable behavior.

## Table of contents

- [Introduction](#1-introduction)
- [Source file basics](#2-source-file-basics)
- [Source file structure](#3-source-file-structure)
- [Formatting](#4-formatting)
- [Naming](#5-naming)
- [Programming Practices](#6-programming-practices)
- [Javadoc](#7-javadoc)
